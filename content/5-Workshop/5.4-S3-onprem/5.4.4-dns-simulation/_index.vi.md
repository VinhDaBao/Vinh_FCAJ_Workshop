...
{{< img "images/5-Workshop/5.4-S3-onprem/hosted-zone.png" "hosted zone" >}}

2. Tạo 1 record mới trong Private Hosted Zone:

{{< img "images/5-Workshop/5.4-S3-onprem/create-record1.png" "Create record" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/record1.png" "record1" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/record2.png" "record 2" >}}

Record mới xuất hiện trên giao diện Route 53.

{{< img "images/5-Workshop/5.4-S3-onprem/result.png" "result" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/route53-1.png" "Inbound endpoint" >}}

3. Sao chép 2 địa chỉ IP trong danh sách vào trình chỉnh sửa.

{{< img "images/5-Workshop/5.4-S3-onprem/route53-2.png" "Ip addresses" >}}

4. Từ giao diện Route 53, chọn  **Resolver** > **Rules** và chọn **Create rule**

{{< img "images/5-Workshop/5.4-S3-onprem/route53-3.png" "Ip addresses" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/dig.png" "create rule" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/subnet.png" "create rule" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/endpoint.png" "create rule" >}}

5. Kết thúc phiên làm việc của Session Manager của bạn:

{{< img "images/5-Workshop/5.4-S3-onprem/terminal.png" "create rule" >}}
