...
{{< img "images/5-Workshop/5.4-S3-onprem/dns.png" "dns name" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/start-session.png" "Start session" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/cli1.png" "user" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/cli2.png" "copy file" >}}
...
{{< img "images/5-Workshop/5.4-S3-onprem/check-bucket.png" "check bucket" >}}
