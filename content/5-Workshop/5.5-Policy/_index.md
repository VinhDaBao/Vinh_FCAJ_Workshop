...
```
{{< img "images/5-Workshop/5.5-Policy/test1.png" "test" >}}
...
{{< img "images/5-Workshop/5.5-Policy/create-bucket.png" "create bucket" >}}

Successfully create bucket

{{< img "images/5-Workshop/5.5-Policy/create-bucket-success.png" "Success" >}}
...
{{< img "images/5-Workshop/5.5-Policy/policy1.png" "policy" >}}
...
{{< img "images/5-Workshop/5.5-Policy/policy2.png" "custom policy" >}}

Successfully customize policy

{{< img "/images/5-Workshop/5.5-Policy/success.png" "success" >}}
...
{{< img "/images/5-Workshop/5.5-Policy/error.png" "error" >}}
...
{{< img "/images/5-Workshop/5.5-Policy/test2.png" "success" >}}

This operation succeeds because it is permitted by the VPC endpoint policy.

{{< img "/images/5-Workshop/5.5-Policy/test2-success.png" "success" >}}
...
{{< img "/images/5-Workshop/5.5-Policy/test2-fail.png" "fail" >}}
